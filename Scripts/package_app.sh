...
BUNDLE_ID=${BUNDLE_ID:-com.buienbar}
...
<dict>
    ...
    <string>BuienBar needs your location to fetch local rain forecasts.</string>
    <key>NSLocationAlwaysAndWhenInUseUsageDescription</key>
    <string>BuienBar uses your location to fetch local rain forecasts.</string>
